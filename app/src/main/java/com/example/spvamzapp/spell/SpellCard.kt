...
)
{
    ...
    if (showRemoveDialog == true) {
        RemovalDialog({showRemoveDialog = false},
            {edcm.removeSpell(spell)
                showRemoveDialog = false},
            stringResource(R.string.delete_dialog_title),
            stringResource(R.string.spell_deletion_prompt),
            Icons.Filled.Delete)
    }
    Card(modifier
        .fillMaxWidth()
            ...
            Row {
                    ...
                    modifier = Modifier.weight(0.1f))
                {
                    Icon(imageVector = Icons.Filled.Create,
                        contentDescription = stringResource(R.string.edit_spell_name_button_desc)
                    )
                }
            }
            Row {
                ...
                IconButton(onClick = {
                    ...
                    Icon(imageVector = Icons.Default.Create,
                        contentDescription = stringResource(R.string.edit_spell_description_button_desc),
            ...
            if (textFieldEditable == 1) {
                IconButton(onClick = {showRemoveDialog = true
                    ...
                    Icon(
                        ...
                        contentDescription = stringResource(R.string.delete_spell_button_desc)
                    )
                }
            }
        }
